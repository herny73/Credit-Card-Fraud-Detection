...
#将好的和坏的中各百分之80加入测试数据集，余下的加入训练数据集，为接下来的训练做准备
...
y_train.Fraud *= ratio
y_test.Fraud *= ratio
#需要注意的是，因为出现坏答案的状况很少，所以我们干脆一份更顶7份强，重复使用这一部分，知道二者数量均衡。
...
# Multiplier maintains a fixed ratio of nodes between each layer. 并没看懂
mulitplier = 1.5 
...
# Percent of nodes to keep during dropout. 没看懂
